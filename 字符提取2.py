...
def generate_character_image_nopinyin(char, font_size=10, image_size=(10, 20), font_family='SimHei', output_path='template_source'):
    ...
    # 使用汉字作为文件名
    image_path = os.path.join(output_path, f"{char}.png")
...
if __name__ == "__main__":
    ...
    prepare_programmatic_templates(template_dir, characters, font_size=750, image_size=(500, 1000), font_family='Microsoft-YaHei')
